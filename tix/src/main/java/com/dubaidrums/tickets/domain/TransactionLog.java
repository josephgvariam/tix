...
public class TransactionLog {
	...
	public static TransactionLog fromJsonToTransactionLog(String json) {
        return new JSONDeserializer<TransactionLog>().use(null, TransactionLog.class).deserialize(json);
    }

	public static String toJsonArray(Collection<TransactionLog> collection) {
        return new JSONSerializer().exclude("*.class").serialize(collection);
    }

	public static Collection<TransactionLog> fromJsonArrayToTransactionLogs(String json) {
        return new JSONDeserializer<List<TransactionLog>>().use(null, ArrayList.class).use("values", TransactionLog.class).deserialize(json);
    }
